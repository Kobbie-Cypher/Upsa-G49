        ...
        <div class="container">
            ...
            <div class="row mt-4 gallery">
                <div class="col-md-3 col-6 mb-3">
                    <img src="assets/images/1.jpg" class="img-fluid rounded preview-img" alt="Gallery Image 1"
                        data-bs-toggle="modal" data-bs-target="#imageModal" data-img="assets/images/1.jpg">
                </div>
                <div class="col-md-3 col-6 mb-3">
                    <img src="assets/images/9.jpg" class="img-fluid rounded preview-img" alt="Gallery Image 2"
                        data-bs-toggle="modal" data-bs-target="#imageModal" data-img="assets/images/9.jpg">
                </div>
                <div class="col-md-3 col-6 mb-3">
                    <img src="assets/images/6.jpg" class="img-fluid rounded preview-img" alt="Gallery Image 3"
                        data-bs-toggle="modal" data-bs-target="#imageModal" data-img="assets/images/6.jpg">
                </div>
                <div class="col-md-3 col-6 mb-3">
