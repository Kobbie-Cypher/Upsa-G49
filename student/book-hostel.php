<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query="INSERT into  registration(hostel,roomno,seater,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresPincode,pmntAddress,pmntCity,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        $stmt = $mysqli->prepare($query);
        $rc=$stmt->bind_param('siiiisissssssisissississi',$hostel,$roomno,$seater,$feespm,$foodstatus,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cpincode,$paddress,$pcity,$ppincode);
        $stmt->execute();
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-4">
                                        <select class="custom-select mr-sm-2" id="hostel" name="hostel">
                                            ...
                                            <option value="La Nyanteh Hotel">La Nyanteh Hostel</option>
                                            <option value="Sight and Sound Hostel">Sight and Sound Hostel</option>
                                            <option value="Abrempong Hostel">Abrempong Hostel</option>
                                            <option value="MB3 Hostel">MB3 Hostel</option>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-4">
                                        <select class="custom-select mr-sm-2" id="duration" name="duration">
                                            ...
                                            <option value="3">Three Semester</option>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="customRadio1">Required
                                            <code>Extra $211 Per Month</code></label>
                                    </div>
                                    <div class="custom-control custom-radio">
